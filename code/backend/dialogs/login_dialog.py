...
class LoginDialog(LogoutDialog):
    def __init__(self, connection_name: str) -> None:
        ...
        self.add_dialog(dialog=WaterfallDialog(
    ...
    async def login_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        if step_context.result:
            await step_context.context.send_activity("Thank you! You have successfully logged in.")
        else:
            await step_context.context.send_activity("I am sorry! Login was not successful. Please try again.")
